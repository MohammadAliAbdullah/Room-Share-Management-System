...
<link href="{{asset('css/bootstrap.min.css')}}" rel="stylesheet">
    ...
    <link href="{{asset('css/daterangepicker.css')}}" id="theme" rel="stylesheet">
    <link href="{{asset('css/bootstrap-material-datetimepicker.css')}}" id="theme" rel="stylesheet">
    <link href="{{asset('css/radiocheckbox-switch.css')}}" rel="stylesheet">
    {{-- toast --}}
...
<body class="fix-header card-no-border logo-center">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <!-- Comment -->
                        <!-- ============================================================== -->
                        <li class="nav-item dropdown" id="a-n">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> 
                                <i class="mdi mdi-message"></i>
                                <div class="notify"> 
                                    <span class="" id="n-heartbit"></span> 
                                    <span class="" id="n-point"></span> </div>
                            </a>
                            <div id="ndc" class="dropdown-menu dropdown-menu-right mailbox scale-up">
                                <ul>
                                    <li>
                                    ...
                                    <li>
                                    <a class="nav-link text-center" href="{{url('admin/notifications')}}"> <strong>Check all notifications</strong> <i class="fa fa-angle-right"></i> </a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <!-- Messages -->
                        <!-- ============================================================== -->
                        <li class="nav-item dropdown" id="a-m">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="" id="2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="mdi mdi-email"></i>
                                <div class="notify"> 
                                    <span class="heartbit" id="m-heartbit"></span> 
                                    <span class="point" id="m-point"></span> </div>
                            </a>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li>
                        <a class="" href="{{url('admin/dashboard')}}" aria-expanded="false"><i class="mdi mdi-gauge"></i>Dashboard</a>
                        </li>
                        <li>
                            <a class="has-arrow " href="#" aria-expanded="false"><i class="mdi mdi-bullseye"></i><span class="hide-menu">Manage</span></a>
                            ...
                            <li><a href="{{url('admin/category')}}">Category</a></li>
                                ...
                                <li>
                                    <a class="has-arrow" href="#" aria-expanded="false">Property</a>
                                    <ul aria-expanded="false" class="collapse">
                                        <li><a href="{{url('admin/property')}}">All</a></li>
                                        <li><a href="{{url('admin/amenities')}}">Amenities</a></li>
                                    </ul>
                                </li>
                                <li><a href="{{url('admin/user')}}">Users</a></li>
                                <li><a href="{{url('admin/owner')}}">Owners</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="two-column">
                            <a href="{{url("admin/booking")}}"><i class="mdi mdi-file"></i>Bookings</a></li>                            
                        </li>
                        {{-- <li>
   ...
   <!-- All Jquery -->
    ...
    <script>        
            ...
            channel.bind('admin-1', function(data) {
                //console.log(data);
                data = JSON.parse(data.message);
                //console.log(data);
                //{"message":"New Listing created with id:11 By Owner Number 1","type":"New Listing created with id:11 By Owner Number 1","from":1,"time":{"date":"2019-04-04 05:38:33.000000","timezone_type":3,"timezone":"UTC"}}
         $content = '<a href="#"><div class="btn btn-danger btn-circle"><i class="fa fa-link"></i></div><div class="mail-contnet"><h5>'+data.type+'</h5><span class="mail-desc">'+data.message+'</span><span class="time">'+data.time.date+'</span></div></a>';
                $("#notification-center").prepend($content);
                //show notification heartbeat and point
                $("#n-heartbit").addClass("heartbit");
                $("#n-point").addClass("point");
                
         $.toast({
    heading: 'Information',
    text:  "New " + data.type + " : "+ data.message,
	...
	hideAfter: 10000
        ...
        $(document).ready(function(){
            $("#a-n").on("shown.bs.dropdown", function(event){
                if($("#n-heartbit").hasClass("heartbit")){$("#n-heartbit").removeClass("heartbit");}
                if($("#n-point").hasClass("point")){$("#n-point").removeClass("point");}
            });
            $("#a-m").on("shown.bs.dropdown", function(event){
                if($("#m-heartbit").hasClass("heartbit")){$("#m-heartbit").removeClass("heartbit");}
                if($("#m-point").hasClass("point")){$("#m-point").removeClass("point");}
            });       
        });//document end
</script>    
</body>
